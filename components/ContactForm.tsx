...
import { VENEZUELA_LOCATIONS, ORGANIZATION_TYPES } from '../constants';
            ...
            <div className="relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        type="submit"
                        className="w-full bg-kiana-green hover:bg-kiana-dark text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-green-200 transition-colors mt-4"
                    >
                        <Send size={18} />
