                    ...
                    <div className="md:w-3/5 p-8 bg-white">
                        ...
                        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                            ...
                            <div className="grid grid-cols-2 gap-y-4 gap-x-8 text-sm">
                                ...
                                {product.nutritional.carbs && (
                                    <div className="flex flex-col border-b border-gray-200 pb-2">
                                        <span className="text-gray-500 text-xs uppercase">Carbohidratos</span>
                                        <span className="font-bold text-gray-900 text-lg">{product.nutritional.carbs}</span>
                                    </div>
                                )}
                                {product.nutritional.iron && (
                                    <div className="flex flex-col border-b border-gray-200 pb-2">
                                        <span className="text-gray-500 text-xs uppercase">Hierro</span>
                                        <span className="font-bold text-gray-900 text-lg">{product.nutritional.iron}</span>
                                    </div>
                                )}
                            </div>

                            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {product.nutritional.vitamins && product.nutritional.vitamins.length > 0 && (
                                    <div>
                                ...
                                {product.nutritional.minerals && product.nutritional.minerals.length > 0 && (
                                    <div>
