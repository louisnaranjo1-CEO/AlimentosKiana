...
('merengon-fresa', 'Merengón Fresa', 'Consumo Masivo', 'Bebida instantánea con el dulce sabor de la fresa. Lista para disfrutar, fortificada con el cariño que merecen los pequeños de la casa. Contiene azúcar.', '["Contiene Azúcar", "Sabor Intenso", "Instantáneo", "Fortificado"]', '{"protein": "9g / 100g", "vitamins": ["Complejo B"], "minerals": ["Calcio", "Hierro"]}', 'bg-pink-200', 'Bolsa 400g', '12 meses'),
...
('chi-cha', 'ChiCha', 'Consumo Masivo', 'Mezcla para preparar la tradicional chicha de arroz venezolana. Cremosa, dulce y con ese sabor a hogar que nos une.', '["Espesa y Cremosa", "Rinde más", "Instantáneo"]', '{"protein": "7g / 100g", "vitamins": ["Vitamina D", "Vitamina A", "Vitamina C"], "minerals": ["Calcio", "Fósforo"]}', 'bg-blue-100', 'Bolsa 500g', '12 meses'),
('fororo', 'Fororo', 'Consumo Masivo', 'Harina de maíz. Alimento tradicional, nutritivo y versátil para toda la familia.', '["100% Maíz", "Sin Tostado", "Rico en vitaminas"]', '{"protein": "7g", "carbs": "81.2g", "iron": "15mg"}', 'bg-orange-200', 'Bolsa 500g', '12 meses'),
('betsy', 'Betsy', 'Consumo Masivo', 'Crema de arroz instantánea enriquecida para los más pequeños. Mezcla y listo.', '["Con Vitaminas", "Rápida preparación", "Hipoalergénico"]', '{"protein": "7g", "carbs": "81.2g", "vitamins": ["A", "D", "C"]}', 'bg-green-100', 'Bolsa 500g', '12 meses'),
