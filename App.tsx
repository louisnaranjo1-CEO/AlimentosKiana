...
function App() {
    ...
    const [whatsappNumber, setWhatsappNumber] = useState<string>('584243533131'); // Default fallback
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            try {
                ...
                // 2. Fetch Benefits
                const { data: benefitsData } = await supabase.from('benefits').select('*').order('order');
    ...
    if (loading) {
        return (
            <div className="h-screen w-full flex flex-col items-center justify-center bg-gray-50">
                <Loader2 className="h-10 w-10 text-kiana-green animate-spin mb-4" />
                <p className="text-gray-500 font-medium">Cargando alimentos con cariño...</p>
            </div>
        );
    }
                ...
                <div className="container mx-auto px-4 relative z-10 text-center text-white">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-gray-100 mb-10 max-w-2xl mx-auto font-medium drop-shadow-md">
                            Productos nutritivos, hechos con dedicación desde el corazón de Venezuela.
                        </p>
                    ...
                    <div className="grid md:grid-cols-4 gap-10 mb-12">
                        ...
                        <div>
                            ...
                            <p className="text-gray-200 text-sm leading-7">
                                ...
                                <a href={`https://wa.me/${whatsappNumber}`} className="text-xl font-bold hover:text-white transition-colors">
                                    +58 {whatsappNumber.replace(/^58/, '')}
                                </a>
                                <br /><br />
